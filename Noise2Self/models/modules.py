...
class ConvBlock(nn.Module):
    ...
    @staticmethod
    def load_weights(filepath,  out_channels, dropout=False, norm='batch', residual=True, activation='leakyrelu', transpose=False):
        model = ConvBlock( out_channels, dropout, norm, residual, activation, transpose):
