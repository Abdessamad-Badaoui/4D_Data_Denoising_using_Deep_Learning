...
class Unet(nn.Module):
    ...
    @staticmethod
    def load_weights(filepath, n_channel_in=1, n_channel_out=1, residual=False, down='conv', up='tconv', activation='selu'):
        model = Unet( n_channel_in, n_channel_out, residual, down, up, activation)
